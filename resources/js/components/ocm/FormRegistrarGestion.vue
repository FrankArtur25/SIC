...
<script>
    export default {
        props:["idCampana","idCliente","tipo","telrecordatorio","telefonosgenerales","valcontacto","datospdp","tipoacceso","numero"],
        data() {
            return {
                respuestas:[],
                ubicabilidad:'',
                ...
                pdps:this.datospdp,
                mensaje:'',
                datos:{detalle:'',montoPDP:'',fechaPDP:null,moneda:0,telefono:this.numero,respuesta:'',rec:'',fechaRec:'',horaRec:'',id:this.idCliente,cod:this.idCampana,tel_rec:'',motivoNoPago:''},
                loadButton:false,
                loadButton2:false,
        ...
        methods:{
            obtenerRespuestas(){
                ...
                axios.get("../datos/listaRespuesta/" + idUbi).then(res=>{
                    if(res.data){
            ...
            listarMotivos(){
                ...
                if(this.tipoacceso!=8){
                    axios.get("../datos/motivo/listaMotivosNoPago").then(res=>{
                        if(res.data){
            ...
            listaTelefonos(){
                ...
                axios.get("../datos/listaTel/"+id).then(res=>{
                    if(res.data){
                        ...
                        if(this.cantclick==1){
                            ...
                            axios.post("../insertarGestion",this.datos).then(res=>{
                                if(res.data[0]=="ok"){
                                    ...
                                    if(this.tipo==1){
                                        this.listaTelefonos();
                                        this.$root.$emit('listarGestionesOcm');
                                    }
